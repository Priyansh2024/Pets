...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void insertPet() {
        ...
        @SuppressLint("ResourceType") InputStream inputstream = CatalogActivity.this.getResources().openRawResource(R.drawable.dog);
        ...
        values.put(PetEntry.COLUMN_PET_IMAGE, img );
